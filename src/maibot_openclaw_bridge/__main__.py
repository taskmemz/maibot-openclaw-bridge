...
async def connect_gateway(url: str, secret: str) -> Any:
    ...
    ws = await asyncio.wait_for(
        websockets.connect(url, ping_interval=30), timeout=15
    )
...
async def execute_task(
    gateway_url: str, secret: str, skill: str, params: dict[str, str], timeout_s: int
) -> dict:
    ...
    while True:
        ...
        if method == "tools/list":
            ...
            result = await execute_task(
                gateway_url, secret, skill_key, args, timeout_s
            )
